              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(hintText: isPerQuantity ? "Venta minima (Cantidad)" : "Venta minima (\$)" ),
                    validator: (value){
                  ...
                  TextFormField(
                    ...
                    keyboardType: TextInputType.number,
                    decoration: InputDecoration(hintText: isDiscount ? "Descuento (%)" : "Producto Gratis"),
                    validator: (value){
                      return value.isNotEmpty ? null : "El campo no puede estar vacio";
                    },
                  ),
              ...
              TextButton(
                onPressed: () async{
                  if(_formkey.currentState.validate()){
                    ...
                    await _editPromotion(idPromo,idProducto,cantitySaleMin,saleMin,cantityFree,discount,active);
